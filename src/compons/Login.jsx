        ...
        <form onSubmit={handleSubmit(loginsubmit)} className='w-[55%]  flex flex-col gap-3 max-sm:gap-6 max-sm:w-[100%]'>
          <div>
            <input
              ...
              type="text" placeholder='example@orbit.io' className={` w-full outline-none  bg-neutral-700/80 py-1 px-2 rounded-sm ${errors.username && "border-[1px] border-red-500/70" }`} />
