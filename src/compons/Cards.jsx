...
const Cards = ({lable, opener=false, children, setopener, classes}) => {
    return (
      <div className={`fixed top-0 left-0 w-full h-screen backdrop-blur-sm  bg-neutral-600/20 justify-center items-center z-50 ${opener?"flex":"hidden"} max-sm:items-end`}>
